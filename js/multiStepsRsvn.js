const DELUXE_PER_NIGHT = 2500;
const DOUBLE_PER_NIGHT = 1800;
const SINGLE_PER_NIGHT = 1500;
...
class ReservationCost {
  ...
  displayRoomPrice () {
    document.getElementsByClassName('roomPriceTxt')[0].innerHTML = 'Rs' + this.numNights() * this.priceByRoomType();
  }
